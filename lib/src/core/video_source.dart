...
sealed class VideoSource {
  ...
  /// 用作 mime 探测的稳定标识。
  /// Stable identity used for mime sniffing.
  String get identity;

  /// 是否为网络来源。只有 [NetworkVideoSource] 为 true。
  /// Whether this source is a network URL.
...
/// 网络来源，由原生播放器直连。
/// Network-backed media source, opened directly by the native player.
...
/// Local file media source (absolute path or `file://` URI).
